...
<div class='body' style="padding: 15px;">
    ...
    <g:form action="createAccount" method="post" autocomplete="off">
        <fieldset>
            ...
            <div class="fieldcontain ${hasErrors(bean: createAccountCommand, field: 'email', 'error')} ">
                <label for='email'><g:message code="OAuthCreateAccountCommand.email.label" default="Email"/>:</label>
                <g:textField name='email' value='${createAccountCommand?.email}'/>
            </div>
    ...
    <g:form action="linkAccount" method="post" autocomplete="off">
        <fieldset>
            ...
            <div class="fieldcontain ${hasErrors(bean: linkAccountCommand, field: 'email', 'error')} ">
                <label for='email'><g:message code="OAuthLinkAccountCommand.email.label" default="Email"/>:</label>
                <g:textField name='email' value='${linkAccountCommand?.email}'/>
            </div>
