...
<body>
	<div ng-cloak class="well" ng-controller="UserCtrl"
		ng-init="initAccountsView()">
		<div class="media" ng-repeat="oAuthID in user.oAuthIDs">
			<a class="pull-left" href="#"> <img class="media-object"
				src="${resource(dir: 'images/providers/')}{{oAuthID.provider}}/logo.jpg"
				alt="{{oAuthID.provider}}" width="70px" height="70px">
			</a>
